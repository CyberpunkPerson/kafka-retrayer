...
class DefaultRetryFlowFilter implements MessageSelector {

    private final RetryProperties retryProperties;

    @Override
    public boolean accept(Message<?> message) { //todo make context know about it's spent instead of static predicate
